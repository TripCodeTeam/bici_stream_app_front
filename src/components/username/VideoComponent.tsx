...
import bgFigures from "@/assets/testImages/backgroundFigures.jpg";
  ...
  return (
    <>
      <div className="flex flex-1 flex-col">
        {playbackId == null && isLive == false && (
          <div className="relative flex h-40 sm:h-60 flex-1 object-cover">
            <img
              className="flex-1 object-cover"
              src={bgFigures.src}
              alt="bgFigures"
            />
            <div className="absolute bottom-4 right-4 text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700">
              <svg
                aria-hidden="true"
